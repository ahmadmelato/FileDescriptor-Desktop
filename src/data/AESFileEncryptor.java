...
public class AESFileEncryptor {
    ...
    private final byte[] IV = {0x01, 0x22, 0x4E, 0x3C, 0x5E, 0x64, 0x19, 0x1A,
        0x59, 0x7A, 0x2F, 0x3F, 0x4D, 0x4E, 0x6F, 0x1F};
...
//            File encryptedFile = new File(selectedFile.getParent(), "encrypted_" + selectedFile.getName());
